            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input id="keywords" type="text" data-kt-branch-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Branch" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-branch-table-toolbar="base">
                        ...
                        <!--begin::Import-->
                        <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#importBranchModal">
                        ...
                        <!--end::Import-->
                        <!--begin::Export-->
                        <button type="button" class="btn btn-light-primary me-3" onclick="window.open('{{ url('/auth/components/branches/export') }}', '_blank')">
                        ...
                        <!--end::Svg Icon-->Add branch</button>
                        <!--end::Add branch-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                    <div class="d-flex justify-content-end align-items-center d-none" data-kt-branch-table-toolbar="selected">
                        <div class="fw-bolder me-5">
                        <span class="me-2" data-kt-branch-table-select="selected_count"></span>Selected</div>
                        <button type="button" class="btn btn-danger" data-kt-branch-table-select="delete_selected">Delete Selected</button>
                    </div>
                    <!--end::Group actions-->
                </div>
                <!--end::Card toolbar-->
...
@push('scripts')
    ...
    <script src="{{ asset('js/datatables/branch.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/forms/branch.js') }}" type="text/javascript"></script>
@endpush
