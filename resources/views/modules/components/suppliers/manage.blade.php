...
@section('content')
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input id="keywords" type="text" data-kt-supplier-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Supplier" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-supplier-table-toolbar="base">
                        ...
                        <!--begin::Import-->
                        <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#importSupplierModal">
                        ...
                        <!--end::Import-->
                        <!--begin::Export-->
                        <button type="button" class="btn btn-light-primary me-3" onclick="window.open('{{ url('/auth/components/suppliers/export') }}', '_blank')">
                        ...
                        <!--end::Svg Icon-->Add Supplier</button>
                        <!--end::Add supplier-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                    <div class="d-flex justify-content-end align-items-center d-none" data-kt-supplier-table-toolbar="selected">
                        ...
                        <span class="me-2" data-kt-supplier-table-select="selected_count"></span>Selected</div>
                        <button type="button" class="btn btn-danger" data-kt-supplier-table-select="delete_selected">Delete Selected</button>
                    </div>
                    <!--end::Group actions-->
                </div>
                <!--end::Card toolbar-->
    ...
    @include('modals.import-supplier')
@endsection
...
@push('scripts')
    ...
    <script src="{{ asset('js/datatables/supplier.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/forms/supplier.js') }}" type="text/javascript"></script>
@endpush
