{{ Form::open(array(
    'url' => 'auth/delivery/post-line-item',
    'method' => 'POST',
    'id' => 'deliveryPostingForm',
    )) 
}}
<div class="fv-row row mb-2 hidden">
    <div class="col-sm-12 text-center">
        {{ Form::label('delivery_line_id', 'ID', ['class' => 'fs-6 fw-bold mb-2']) }}
        {{ 
    ...
    <div class="col-sm-12 text-center">
        {{ Form::label('delivery_idx', 'ID', ['class' => 'fs-6 fw-bold mb-2']) }}
        {{ 
            Form::text($name = 'delivery_idx', $value = '', 
            $attributes = array(
                'id' => 'delivery_idx',
                'class' => 'text-center form-control form-control-solid',
                'disabled' => 'disabled'
...
<div class="fv-row row mb-2">
    <div class="col-sm-12 text-center">
        {{ Form::label('date_delivered', 'Date Delivered', ['class' => 'fs-6 fw-bold mb-2']) }}
        {{ 
            Form::text($name = 'date_delivered', $value = '', 
            $attributes = array(
                'id' => 'date_delivered',
