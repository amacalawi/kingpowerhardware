...
<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
            <!-- <a href="index.html">
                <img alt="Logo" src="{{ asset('assets/media/logos/logo-2-dark.svg') }}" class="h-35px" />
            </a> -->
            <h1 class="m-0" style="color:#009ef7">P I M S</h1>
        </div>
        <!--end::Logo-->
        <!--begin::Wrapper-->
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            ...
            <div class="d-flex align-items-stretch" id="kt_header_nav">
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                    <!--begin::Menu-->
                    <div class="menu show menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        @foreach ($menus as $menu)
                            @foreach ($menu['modules'] as $module)
                                @php
                                    $show = (strtolower($module['slug']) == strtolower(Request::segment(2))) ? 'here show' : '';
                                @endphp
                                @if ( !empty($menu['sub_modules'][$module['id']]) )
                                    <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item {{ $show }} menu-lg-down-accordion me-lg-1">
                                        ...
                                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link py-3" href="{{ url('auth/'.$module['slug'].'/'.$submodule['slug']) }}">
                                                    @php print(html_entity_decode(htmlspecialchars($submodule['icon']))); @endphp
                                                    <span class="menu-title ms-3">{{ $submodule['name'] }}</span>
                                                </a>
                                            </div>
                                            @endforeach
                                        </div>
                                ...
                                @else
                                    <div class="menu-item {{ $show }} menu-lg-down-accordion me-lg-1">
                                        <a class="menu-link py-3" href="{{ url('auth/'.$module['slug']) }}">
                                            <span class="menu-title">{{ $module['name'] }}</span>
                                        </a>
                                    </div>
                                @endif
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-5">
                                <a onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="menu-link px-5">Sign Out</a>
